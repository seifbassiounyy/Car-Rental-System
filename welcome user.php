...
<body>
	<nav class ="navbar">
		<div class="logo"><h1>Car Rental <i class="fas fa-car"></i></h1></div>
		<ul class="menu">
			<li><a href="#">Home</a></li>
	...
	<section class="content">
		<div class="welcome"><p>Welcome Back Ali</p></div>
	...
	<h1 class="pheading" id="move">Availabe cars in your country</h1>
