...
ALTER TABLE CAR_RENTAL_COMPANY.CAR ADD FOREIGN KEY (Office_id) REFERENCES CAR_RENTAL_COMPANY.OFFICE  (Office_id);
...
ALTER TABLE CAR_RENTAL_COMPANY.CAR ADD CONSTRAINT CK_Table_Status CHECK (Status IN ('active', 'out_of_service', 'rented','reserved'));
